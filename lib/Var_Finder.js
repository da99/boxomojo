...
Var_Finder.Box = function (machine, verb) {
...
Var_Finder.Box.prototype.next_verb = Var_Finder.next_verb;

Var_Finder.Box.prototype.next = function () {
  if (this.done)
    return null;
  ...
  if (this.outside_finder) {
    ...
    if (!this.machine.is_local() && this.machine.Outside) {
      this.outside_finder = new Var_Finder.Box(this.machine.Outside, this.verb);
...
Var_Finder.For_Noun.prototype.next_verb = Var_Finder.next_verb;
