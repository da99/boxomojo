...
var Parser = exports.Parser = function (str) {
...
Parser.prototype.grab_func_call = function () {
  var trim = this.trim;
  this.shift();
  return Parser.To_Function_Call(trim);
};
...
Parser.To_Raw = function (kind, tokens) {
  var o = {
    'raw?' : true,
    kind   : kind,
    tokens : tokens
...
Parser.To_Function_Call = function (name) {
  var r = Parser.To_Raw('func_call', [name]);
  r.value = name;
  return r;
};

Parser.To_Run_Now_Function = function (arr) {
  return Parser.To_Raw('()', arr);
};

Parser.To_Function = function (arr) {
  return Parser.To_Raw('f[]f', arr);
};

Parser.To_List = function (arr) {
  return Parser.To_Raw('[]', arr);
};

Parser.To_Object = function (arr) {
  return Parser.To_Raw('{}', arr);
};
