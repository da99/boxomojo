...
Box.prototype.compile_forward = function () {
  ...
  switch (kind) {
    ...
    case 'run now function?':
      throw new Error('not implemented: compiling raw run now function');
      break;
    case 'function':
      throw new Error('not implemented: compiling raw function');
      break;
    case 'list':
      fin = Objects.List(val, this);
      break;
    case 'index':
      fin = Objects.Index(val, this);
      break;
    case 'object':
      throw new Error('not implemented: compiling raw object');
      break;
    default:
