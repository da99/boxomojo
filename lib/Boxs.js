...
Core               = require('boxomojo/lib/Core'),
Boxs_Box           = require('boxomojo/lib/Boxs_Box'),
Boxs_Function      = require('boxomojo/lib/Boxs_Function'),
Boxs_Function_Call = require('boxomojo/lib/Boxs_Function_Call'),
Boxs_List          = require('boxomojo/lib/Boxs_List'),
Boxs_Number        = require('boxomojo/lib/Boxs_Number'),
Boxs_String        = require('boxomojo/lib/Boxs_String');

if (!Object.prototype.is_boxomojo_object) {

  // === Yes. I wrote the following.
  // === No, I am not crazy.
  Object.prototype.is_boxomojo_object = function () { return false; };
...
Boxs['{}'] = function (raw_or_tokens, box) {
  var tokens = raw_or_tokens.tokens || raw_or_tokens;
  var o = new Boxs['x[]x'](tokens, box, '{}');
  o['klass'] = Boxs['{}'];
  return o;
};
