...
var Indexs_Mod         = Objects.init_module(Core_Modules.Index);
...
Objects.Function_Call = function (raw, box) {
  return( new Base(raw, box, 'function call', Function_Calls_Mod) );
};
...
Objects['Function'] = function (raw, box) {
  var o = new Base(raw, box, 'function', Functions_Mod);
  return o;
};
