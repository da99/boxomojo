...
var Factor_Script_Object = function () {
  this.Returns           = [];
  this.Code              = null;
  this.Vars              = {};
  this['Function Lists'] = [];
...
Factor_Script_Object.prototype.is_factor_script_object  = function () {
  return true;
};

Factor_Script_Object.prototype.value = function () {
  return this.Vars['value'];
};

Factor_Script_Object.prototype.create = function(name, val) {
  this.Vars[name] = val;
  return val;
};

Factor_Script_Object.prototype.read = function(name) {
  return Var_Finder.Factor_Script_Object(this, name);
};

Factor_Script_Object.prototype.read_verb = function(name) {
  return Var_Finder.Factor_Script_Object(this, name, true);
};

Factor_Script_Object.prototype.update = function(name, val) {
  this.Vars[name] = val;
  return val;
};

Factor_Script_Object.prototype.delete = function (name) {
...
module.exports = {
  Factor_Script_Object : Factor_Script_Object
};
